...
function modifyReviewBtn(){ 
	if(document.getElementById("MRlocalTitle").value == ""){
		...
		$("#modifyReviewBtn").attr("data-dismiss","modal");
...
<div class="modal fade" id="scheduleReviewModifyModal" role="dialog" data-backdrop="static">
	<div class="modal-dialog" style="max-width: 1200px; width: 1000px;">
		...
		<div class="modal-content" style="padding: 15px 15px 15px 15px;">
			<div>
				...
				<div class="smap_wrap">
				    <div id="MRmodifyMap" style="width:100%;height:300px;position:relative;overflow:hidden;"></div>
				...
				<script src="${root}/resources/js/schedule_modify_reviewmodal.js"></script>
...
<!-- 					<input type="button" value="등록" class="btn btn-primary py-2 px-3" onclick="save()"/>	-->
					<input type="button" value="등록" class="btn btn-primary py-2 px-3" id="modifyReviewBtn" onclick="javascript:modifyReviewBtn();" data-dismiss="modal"/>
				</div>
