...
<head>
  ...
  <%@ include file="/WEB-INF/views/include/nav.jsp"%>
    <!-- 대문 -->
    <div class="hero-wrap js-fullheight3" style="background-image: url('${root}/resources/images/bg_1.jpg')">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight3 align-items-center justify-content-start" data-scrollax-parent="true">
